...
def JoyToTwist():
    ...
    joy_subscriber = rospy.Subscriber("joy", Joy, handleJoyMsg, queue_size=2)
...
def handleJoyMsg(data):
    ...
    scalers = [0.8,  0.8,  0.8,  -3.14, -3.14, -3.14]
    # scalers=[i*10 for i in scalers]
    # Setup Twist Publisher
    twist_publisher = rospy.Publisher("mobile_base/commands/velocity", Twist,queue_size=5)
    msg = Twist()
    rospy.loginfo(msg)
